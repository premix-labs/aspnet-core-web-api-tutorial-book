---
title: "ป้องกันไม่ให้ Admin ลบตัวเองผิดพลาด"
description: "เพิ่ม business rule เพื่อป้องกัน Admin ทำ action อันตรายกับบัญชีตัวเอง"
chapter: 45
icon: user-cog
part: "ภาค 7: Admin System"
difficulty: intermediate
prerequisites: ["เปลี่ยน Role หรือสถานะผู้ใช้"]
learningOutcomes: ["อธิบายและลงมือทำหัวข้อ ป้องกันไม่ให้ Admin ลบตัวเองผิดพลาด ได้"]
