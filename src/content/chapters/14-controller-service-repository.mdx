---
title: "แยก Controller, Service, Repository"
description: "จัดชั้นของ code เพื่อให้โปรเจกต์อ่านง่ายและดูแลต่อได้"
chapter: 14
icon: layout-dashboard
part: "ภาค 3: Architecture"
difficulty: beginner
prerequisites: ["ภาค 3 - จัดโครงสร้างโปรเจกต์ให้พร้อมโต"]
learningOutcomes: ["อธิบายและลงมือทำหัวข้อ แยก Controller, Service, Repository ได้"]
