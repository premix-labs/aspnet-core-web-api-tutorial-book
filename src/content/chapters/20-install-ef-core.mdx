---
title: "ติดตั้ง Entity Framework Core"
description: "เพิ่ม package และเครื่องมือที่จำเป็นสำหรับใช้ EF Core กับ SQL Server"
chapter: 20
icon: database
part: "ภาค 4: Database"
difficulty: intermediate
prerequisites: ["ภาค 4 - เชื่อมต่อฐานข้อมูลด้วย EF Core"]
learningOutcomes: ["อธิบายและลงมือทำหัวข้อ ติดตั้ง Entity Framework Core ได้"]
