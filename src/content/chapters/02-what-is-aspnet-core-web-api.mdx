---
title: "ASP.NET Core Web API คืออะไร"
description: "ทำความเข้าใจบทบาทของ ASP.NET Core Web API ในงาน backend"
chapter: 2
icon: settings
part: "ภาค 1: พื้นฐาน"
difficulty: beginner
prerequisites: ["ภาค 1 - พื้นฐานก่อนสร้าง API"]
learningOutcomes: ["อธิบายและลงมือทำหัวข้อ ASP.NET Core Web API คืออะไร ได้"]
...
บทนี้เป็นบทปูภาพรวม ยังไม่ต้องติดตั้งอะไรและยังไม่ต้องเขียน code

ถ้าคุณเป็น junior developer ให้จับประเด็นหลักก่อนว่า API คือชั้นกลางระหว่าง client กับ database ส่วนคำที่ยังไม่คุ้น เช่น JWT, middleware, EF Core หรือ Docker จะมีบทเฉพาะของตัวเองในภายหลัง
...
บทนี้ยังไม่เปลี่ยนไฟล์ในโปรเจกต์ เพราะเรายังไม่ได้สร้างโปรเจกต์จริง จุดประสงค์คือเข้าใจภาพรวมก่อนเริ่มใช้ `dotnet CLI` ในบทถัดไป
