...
เลข version อาจไม่ตรงกับตัวอย่างแบบเป๊ะ แต่สำหรับหนังสือนี้ควรเห็น SDK ที่ขึ้นต้นด้วย `10.` เป็นอย่างน้อย ถ้า `dotnet --version` แสดงรุ่นเก่ากว่า ให้ตรวจต่อด้วย `dotnet --list-sdks` เพราะเครื่องหนึ่งอาจติดตั้ง SDK หลายรุ่นพร้อมกันได้
