...
| Feature | Files | Tests |
| --- | --- | --- |
| Lockout fields และ user state | `examples/final-backend-api/Backend.Api/Models/User.cs`<br/>`examples/final-backend-api/Backend.Api/Data/AppDbContext.cs` | `examples/final-backend-api/Backend.Api.Tests/DatabaseModelTests.cs` |
| Lockout config และ validation ตอน start | `examples/final-backend-api/Backend.Api/Options/AccountLockoutOptions.cs`<br/>`examples/final-backend-api/Backend.Api/Program.cs`<br/>`examples/final-backend-api/Backend.Api/appsettings.json` | `examples/final-backend-api/Backend.Api.Tests/AuthIntegrationTests.cs` |
| Login failure, lockout, reset failed count และ audit log | `examples/final-backend-api/Backend.Api/Services/AuthService.cs`<br/>`examples/final-backend-api/Backend.Api/Constants/AuditActions.cs` | `examples/final-backend-api/Backend.Api.Tests/AuthIntegrationTests.cs`<br/>`examples/final-backend-api/Backend.Api.Tests/AuditLogIntegrationTests.cs` |
