...
| Feature | Files | Tests |
| --- | --- | --- |
| CORS config และ production startup guard | `examples/final-backend-api/Backend.Api/Program.cs`<br/>`examples/final-backend-api/Backend.Api/appsettings.json` | `examples/final-backend-api/Backend.Api.Tests/ProductionHardeningIntegrationTests.cs` |
| Auth rate limiting policy | `examples/final-backend-api/Backend.Api/Program.cs`<br/>`examples/final-backend-api/Backend.Api/Controllers/AuthController.cs` | `examples/final-backend-api/Backend.Api.Tests/ProductionHardeningIntegrationTests.cs` |
| Security headers middleware และ correlation id header | `examples/final-backend-api/Backend.Api/Program.cs` | `examples/final-backend-api/Backend.Api.Tests/ProductionHardeningIntegrationTests.cs` |
...
ใน final project ถ้าเป็น Production แล้วไม่ได้ตั้ง `Cors:AllowedOrigins` ระบบจะไม่ยอม start:
...
final project และ validation project เพิ่ม headers เหล่านี้:
